...
const ProfileScreen = ({ navigation }) => {
  ...
  if (loading) {
    return (
      <LinearGradient colors={['#444', '#444']} style={tw`flex-1 justify-center items-center`}>
  ...
  if (error) {
    return (
      <LinearGradient colors={['#444', '#444']} style={tw`flex-1 justify-center items-center p-4`}>
